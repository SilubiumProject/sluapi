...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.silubiumd.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    issrc20Transfer: transaction.issrc20Transfer,
  };
...
TxController.prototype.transformSilubiumTransaction = function(transaction) {
