 ...
 * @param {Object} opts.src20TransferRepository
 * @constructor
 */
...
TransactionService.prototype.addReceiptIfTransfersExists = function(transaction, next) {
    ...
    return async.waterfall([
        function(callback) {
            ...
            return self.src20TransferRepository.isTransfersExistsByTxHash(transaction.hash, function(err, exists) {

                transaction.issrc20Transfer = exists;
